...
exports.default = function (html) {
    ...
    var vnodes = convertNodes(_htmlParseStringify2.default.parse(html), createdVNodes, context);
...
function toVNode(node, createdVNodes, context) {
    ...
    if (node.type === 'text') {
        ...
        newNode = (0, _snabbdom.h)(node.name, buildVNodeData(node, context), convertNodes(node.children, createdVNodes, context));
    }
