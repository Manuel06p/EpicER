(function (factory) {
  ...
  var KClass = kotlin_kotlin.$_$.qd;
  var Triple = kotlin_kotlin.$_$.xg;
  var Pair = kotlin_kotlin.$_$.rg;
  var Entry = kotlin_kotlin.$_$.w5;
  var KtMutableMap = kotlin_kotlin.$_$.g6;
  ...
  var KtMutableList = kotlin_kotlin.$_$.d6;
  ...
  var toHashSet = kotlin_kotlin.$_$.v9;
  var toBooleanArray = kotlin_kotlin.$_$.u9;
  var withIndex = kotlin_kotlin.$_$.fa;
  var to = kotlin_kotlin.$_$.zh;
  var lazy_0 = kotlin_kotlin.$_$.qh;
  var contentEquals = kotlin_kotlin.$_$.b7;
  var until = kotlin_kotlin.$_$.pd;
  ...
  var Duration = kotlin_kotlin.$_$.zf;
  var Companion_getInstance = kotlin_kotlin.$_$.s4;
  var Uuid = kotlin_kotlin.$_$.dg;
  ...
  var isIntArray = kotlin_kotlin.$_$.nc;
  ...
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.k3;
  var UIntArray__get_impl_gp5kza = kotlin_kotlin.$_$.o3;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.l3;
  var ShortCompanionObject_getInstance = kotlin_kotlin.$_$.p4;
  var isShortArray = kotlin_kotlin.$_$.rc;
  ...
  var isByteArray = kotlin_kotlin.$_$.ic;
  var Companion_getInstance_6 = kotlin_kotlin.$_$.x4;
  var _UByteArray___get_size__impl__h6pkdv = kotlin_kotlin.$_$.i3;
  ...
  var copyOf_3 = kotlin_kotlin.$_$.m7;
  ...
  var copyOf_5 = kotlin_kotlin.$_$.i7;
  var _UByteArray___get_storage__impl__d4kctt = kotlin_kotlin.$_$.j3;
  var _UByteArray___init__impl__ip4y9n_0 = kotlin_kotlin.$_$.e3;
  var UByteArray__set_impl_jvcicn = kotlin_kotlin.$_$.h3;
  var copyOf_6 = kotlin_kotlin.$_$.g7;
  ...
  var get_indices_0 = kotlin_kotlin.$_$.b8;
  ...
  function ULongSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.ULong', serializer_5(Companion_getInstance_2()));
  }
  ...
  function initBuiltins() {
    return mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_1(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_2(Companion_getInstance_1())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_3(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_4(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_5(Companion_getInstance_2())), to(PrimitiveClasses_getInstance().get_longArrayClass_v379a4_k$(), LongArraySerializer()), to(getKClass(ULong), serializer_6(Companion_getInstance_3())), to(getKClass(ULongArray), ULongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_7(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(getKClass(UInt), serializer_8(Companion_getInstance_4())), to(getKClass(UIntArray), UIntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_9(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(getKClass(UShort), serializer_10(Companion_getInstance_5())), to(getKClass(UShortArray), UShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_11(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(getKClass(UByte), serializer_12(Companion_getInstance_6())), to(getKClass(UByteArray), UByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_13(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_14(Unit_getInstance())), to(PrimitiveClasses_getInstance().get_nothingClass_7ivpcc_k$(), NothingSerializer()), to(getKClass(Duration), serializer_15(Companion_getInstance())), to(getKClass(Uuid), serializer_16(Companion_getInstance_0()))]);
  }
  ...
  _.$_$.n = typeParametersSerializers;
  _.$_$.o = GeneratedSerializer;
  _.$_$.p = InlinePrimitiveDescriptor;
  _.$_$.q = PluginGeneratedSerialDescriptor;
  _.$_$.r = throwMissingFieldException;
  _.$_$.s = KSerializer;
  _.$_$.t = SealedClassSerializer;
  _.$_$.u = serializer_0;
  //endregion
  return _;
}));
