(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    globalThis['kobweb-frontend-kobweb-core'] = factory(typeof globalThis['kobweb-frontend-kobweb-core'] === 'undefined' ? {} : globalThis['kobweb-frontend-kobweb-core'], globalThis['kobweb-frontend-browser-ext'], globalThis['kotlin-kotlin-stdlib'], globalThis['html-html-core'], globalThis['kobweb-frontend-compose-html-ext'], globalThis['compose-multiplatform-core-compose-runtime-runtime'], globalThis['kobweb-common-client-server-internal']);
  }
}(function (_, kotlin_com_varabyte_kobweb_browser_ext, kotlin_kotlin, kotlin_org_jetbrains_compose_html_html_core, kotlin_com_varabyte_kobweb_compose_html_ext, kotlin_org_jetbrains_compose_runtime_runtime, kotlin_com_varabyte_kobweb_client_server_internal) {
  'use strict';
  ...
  var startsWith_0 = kotlin_kotlin.$_$.m8;
  ...
  var substringAfter = kotlin_kotlin.$_$.p8;
  ...
  function ApiFetcher(window_0) {
    this.j39_1 = window_0;
    this.k39_1 = logOnError$factory(get_http(this.j39_1));
  }
  protoOf(ApiFetcher).l39 = function (_set____db54di) {
    var tmp0 = this.k39_1;
    logOnError$factory_0();
    tmp0.set(_set____db54di);
    return Unit_instance;
  };
  protoOf(ApiFetcher).m39 = function () {
    var tmp0 = this.k39_1;
    // Inline function 'kotlin.getValue' call
  ...
  function KobwebApp(content, $composer, $changed) {
    ...
    $composer_0 = $composer_0.a1w(1293008755);
    var $dirty = $changed;
    if (($changed & 6) === 0)
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.l21(KobwebApp$lambda(content, $changed));
    }
  }
  function DefaultStyleSheet$lambda($this$layer) {
    $this$layer.g2v('html, body', DefaultStyleSheet$lambda$lambda);
    $this$layer.g2v('*', DefaultStyleSheet$lambda$lambda_0);
    return Unit_instance;
  }
  ...
  protoOf(DefaultStyleSheet).f2v = function (selector, cssRule) {
  ...
  protoOf(AppGlobals).t39 = function (values) {
  ...
  function RouteInfo(route, dynamicParams) {
    this.u39_1 = route;
    this.v39_1 = dynamicParams;
    this.w39_1 = substringAfterLast(this.u39_1.c3a_1, _Char___init__impl__6a9atx(47));
    this.x39_1 = this.u39_1.c3a_1;
    this.y39_1 = plus(this.u39_1.d3a_1, this.v39_1);
    this.z39_1 = this.u39_1.d3a_1;
    this.a3a_1 = this.u39_1.e3a_1;
  }
  protoOf(RouteInfo).f3a = function () {
    return this.u39_1.toString();
  };
  ...
  protoOf(RouteInfo).equals = function (other) {
    ...
    if (other instanceof RouteInfo) {
      tmp_1 = other.x39_1 === this.x39_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = equals(other.y39_1, this.y39_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = other.a3a_1 == this.a3a_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(RouteInfo).hashCode = function () {
    ...
    result = imul(31, result) + hashCode(this.y39_1) | 0;
    var tmp = imul(31, result);
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.a3a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    result = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
    return result;
  };
  protoOf(RouteInfo).g3a = function (path, queryParams, fragment, dynamicParams) {
    return new RouteInfo(Route_init_$Create$(path, queryParams, fragment), dynamicParams);
  };
  protoOf(RouteInfo).h3a = function (path, queryParams, fragment, dynamicParams, $super) {
    path = path === VOID ? this.u39_1.c3a_1 : path;
    queryParams = queryParams === VOID ? this.u39_1.d3a_1 : queryParams;
    fragment = fragment === VOID ? this.u39_1.e3a_1 : fragment;
    dynamicParams = dynamicParams === VOID ? this.v39_1 : dynamicParams;
    return $super === VOID ? this.g3a(path, queryParams, fragment, dynamicParams) : $super.g3a.call(this, path, queryParams, fragment, dynamicParams);
  };
  function Companion() {
  }
  protoOf(Companion).j3a = function () {
    var tmp = this.i3a_1;
    if (!(tmp == null))
      return tmp;
    else {
  ...
  protoOf(Companion).k3a = function (router) {
    this.i3a_1 = new PageContext(router);
  };
  ...
  function PageContext(router) {
    this.l3a_1 = router;
    this.m3a_1 = mutableStateOf(null);
  }
  protoOf(PageContext).n3a = function (value) {
    this.m3a_1.o11(value);
  };
  protoOf(PageContext).o3a = function () {
    var tmp0_elvis_lhs = this.m3a_1.e2();
    var tmp;
  ...
  function MutableKobwebConfig() {
    this.r3a_1 = new MutableOpenLinkStrategies();
  }
  protoOf(MutableKobwebConfig).s3a = function () {
    return this.r3a_1;
  };
  function Companion_0() {
  }
  protoOf(Companion_0).t3a = function () {
  ...
  protoOf(MutableOpenLinkStrategies).w3a = function () {
    return this.u3a_1;
  };
  protoOf(MutableOpenLinkStrategies).x3a = function () {
    return this.v3a_1;
  };
  ...
  function Anchor(href, attrs, openInternalLinksStrategy, openExternalLinksStrategy, updateHistoryMode, content, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.a1w(1682374411);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.j1l(href) ? 4 : 2);
    if (!(($default & 2) === 0))
      $dirty = $dirty | 48;
    ...
    if (!(($default & 4) === 0))
      ...
      $dirty = $dirty | ($composer_0.j1l(openInternalLinksStrategy_0._v) ? 256 : 128);
    if (!(($default & 8) === 0))
      $dirty = $dirty | 3072;
    else if (($changed & 3072) === 0)
      $dirty = $dirty | ($composer_0.j1l(openExternalLinksStrategy_0._v) ? 2048 : 1024);
    if (!(($default & 16) === 0))
      $dirty = $dirty | 24576;
    else if (($changed & 24576) === 0)
      $dirty = $dirty | ($composer_0.j1l(updateHistoryMode_0._v) ? 16384 : 8192);
    if (!(($default & 32) === 0))
      $dirty = $dirty | 196608;
    else if (($changed & 196608) === 0)
      $dirty = $dirty | ($composer_0.w1u(content_0._v) ? 131072 : 65536);
    if (!(($dirty & 74899) === 74898) || !$composer_0.s1t()) {
      ...
      var tmp = Companion_instance_1.y3a(href);
      $composer_0.z1t(-901903562);
      var tmp0 = $composer_0;
      // Inline function 'androidx.compose.runtime.cache' call
      var invalid = !!(!!(!!(!!(!!(($dirty & 112) === 32 | ($dirty & 896) === 256) | ($dirty & 7168) === 2048) | $composer_0.w1u(ctx)) | ($dirty & 14) === 4) | ($dirty & 57344) === 16384);
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.l21(Anchor$lambda_0(href, attrs_0, openInternalLinksStrategy_0, openExternalLinksStrategy_0, updateHistoryMode_0, content_0, $changed, $default));
    }
  }
  function Anchor$lambda$lambda($openInternalLinksStrategy, $openExternalLinksStrategy, $ctx, $href, $updateHistoryMode) {
    return function (evt) {
      ...
      var openInternalLinksStrategy = tmp0_elvis_lhs == null ? toOpenLinkStrategy(evt, Companion_instance_0.t3a().s3a().w3a()) : tmp0_elvis_lhs;
      var tmp1_elvis_lhs = $openExternalLinksStrategy._v;
      var openExternalLinksStrategy = tmp1_elvis_lhs == null ? toOpenLinkStrategy(evt, Companion_instance_0.t3a().s3a().x3a()) : tmp1_elvis_lhs;
      var tmp2_elvis_lhs = $updateHistoryMode._v;
      $ctx.l3a_1.d3b($href, tmp2_elvis_lhs == null ? UpdateHistoryMode_PUSH_getInstance() : tmp2_elvis_lhs, openInternalLinksStrategy, openExternalLinksStrategy);
      evt.r2x();
      evt.s2x();
      return Unit_instance;
    };
  ...
  function Anchor$lambda($attrs, $openInternalLinksStrategy, $openExternalLinksStrategy, $ctx, $href, $updateHistoryMode) {
    return function ($this$A) {
      ...
      $this$A.w2r(Anchor$lambda$lambda($openInternalLinksStrategy, $openExternalLinksStrategy, $ctx, $href, $updateHistoryMode));
      return Unit_instance;
    };
  }
  ...
  protoOf(Companion_1).e3b = function (value) {
    Companion_instance_2.g3b(new BasePathImpl(value));
  };
  protoOf(Companion_1).e2 = function () {
    return Companion_instance_2.i3b().h3b_1;
  };
  protoOf(Companion_1).y3a = function (path) {
    return Companion_instance_2.i3b().y3a(path);
  };
  ...
  protoOf(Companion_2).g3b = function (value) {
    // Inline function 'kotlin.check' call
    if (!(this.f3b_1 == null)) {
  ...
  protoOf(Companion_2).j3b = function () {
    if (this.f3b_1 == null) {
      this.f3b_1 = new BasePathImpl('');
    }
    return this.f3b_1;
  };
  protoOf(Companion_2).i3b = function () {
    return ensureNotNull(this.j3b());
  };
  ...
  function BasePathImpl(value) {
    ...
    tmp.h3b_1 = tmp2_elvis_lhs == null ? '' : tmp2_elvis_lhs;
  }
  protoOf(BasePathImpl).y3a = function (path) {
    if (isBlank(this.h3b_1))
      return path;
    if (!startsWith_0(path, '/'))
      return path;
    return dropLast(this.h3b_1, 1) + path;
  };
  ...
  function prependIf(_this__u8e3s4, condition, path) {
    return condition ? _this__u8e3s4.y3a(path) : path;
  }
  ...
  function toOpenLinkStrategy(_this__u8e3s4, default_0) {
    ...
    return _this__u8e3s4.l2y_1 || _this__u8e3s4.x2y_1 ? OpenLinkStrategy_IN_NEW_TAB_getInstance() : default_0;
  }
  ...
  function PageData(pageMethod, routeInfo) {
    this.k3b_1 = pageMethod;
    this.l3b_1 = routeInfo;
  }
  ...
  function Route_init_$Init$(path, queryParams, fragment, $this) {
    ...
    if (!queryParams.p()) {
      this_0.g8(_Char___init__impl__6a9atx(63));
      ...
      while (_iterator__ex2g4s.h()) {
        ...
        if (charSequenceLength(value) > 0) {
          this_1.g8(_Char___init__impl__6a9atx(61));
          this_1.f8(value);
        }
        var tmp$ret$7 = this_1.toString();
        destination.e(tmp$ret$7);
      }
      this_0.f8(joinToString(destination, '&'));
    }
    if (!(fragment == null)) {
      this_0.g8(_Char___init__impl__6a9atx(35));
      this_0.f8(fragment);
    }
  ...
  protoOf(Companion_3).m3b = function (path) {
    return !(this.n3b(path) == null);
  };
  protoOf(Companion_3).n3b = function (path) {
    var tmp;
    try {
      tmp = new Route(path);
    } catch ($p) {
  ...
  protoOf(Companion_3).o3b = function (url) {
    var tmp0_elvis_lhs = this.n3b(removePrefix(url.href, url.origin));
  ...
  function Route(pathQueryAndFragment) {
    ...
    this.b3a_1 = new URL(pathQueryAndFragment, 'http://unused.com');
    var isAbsolute = startsWith_0(pathQueryAndFragment, '/');
    var tmp_1 = this;
    var tmp_2;
    if (isAbsolute) {
      tmp_2 = this.b3a_1.pathname;
    } else {
      // Inline function 'kotlin.also' call
      var this_0 = drop(this.b3a_1.pathname, 1);
      // Inline function 'com.varabyte.kobweb.navigation.Route.<anonymous>' call
      // Inline function 'kotlin.check' call
      if (!(first(this.b3a_1.pathname) === _Char___init__impl__6a9atx(47))) {
    ...
    $l$block: {
      ...
      var this_2 = this.b3a_1.search;
      if (charSequenceLength(this_2) === 0) {
        break $l$block;
      }
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = split(removePrefix(this.b3a_1.search, '?'), charArrayOf([_Char___init__impl__6a9atx(38)])).g();
      while (_iterator__ex2g4s.h()) {
    ...
    tmp_4.e3a_1 = tmp0_safe_receiver == null ? null : removePrefix(tmp0_safe_receiver, '#');
  }
  protoOf(Route).toString = function () {
    return this.c3a_1 + this.b3a_1.search + this.b3a_1.hash;
  };
  ...
  function createPageData(_this__u8e3s4, route, errorPageContent) {
    ...
    var tmp0_elvis_lhs = self_0.g39(route.c3a_1, true);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.takeIf' call
      var this_0 = route.c3a_1;
      var tmp_0;
      ...
      if (tmp_0 == null) {
        ...
        var tmp_2;
        if (startsWith_0(route.c3a_1, duplicatedRoutePrefix)) {
          // Inline function 'kotlin.also' call
          var this_2 = self_0.g39(replace(route.c3a_1, duplicatedRoutePrefix, Companion_instance_1.e2()), true);
          // Inline function 'com.varabyte.kobweb.navigation.createPageData.<anonymous>.<anonymous>' call
          if (!(this_2 == null)) {
            console.warn("Please report to the site owner: detected a case where the site's base path was prepended an extra time (`" + route.c3a_1 + '`). `navigateTo` and `tryRoutingTo` now auto-prepend a prefix themselves, so the site owner should search their code for `BasePath.prepend` or `RoutePrefix.prepend` and remove any that have become unnecessary.');
          }
          tmp_2 = this_2;
        } else {
          tmp_2 = null;
    ...
    var resolved = tmp_3;
    var tmp3_elvis_lhs = last(resolved).z38_1.u37();
    ...
    while (_iterator__ex2g4s.h()) {
      var element = _iterator__ex2g4s.i();
      // Inline function 'com.varabyte.kobweb.navigation.createPageData.<anonymous>' call
      var tmp_4 = element.z38_1;
      if (tmp_4 instanceof DynamicNode) {
        var tmp1 = element.z38_1.j2c();
        // Inline function 'kotlin.collections.set' call
        var value = element.a39_1;
        dynamicParams.a5(tmp1, value);
      }
    }
    return new PageData(pageMethod, new RouteInfo(Route_init_$Create$(toRouteString(resolved), route.d3a_1, route.e3a_1), dynamicParams));
  }
  ...
  function updatePageContext(_this__u8e3s4, $this, pathQueryAndFragment) {
    if (startsWith_0(pathQueryAndFragment, '#')) {
      var tmp0_safe_receiver = _this__u8e3s4.m3a_1.e2();
      var tmp;
      if (tmp0_safe_receiver == null) {
        tmp = null;
      } else {
        // Inline function 'kotlin.let' call
        _this__u8e3s4.m3a_1.o11(tmp0_safe_receiver.h3a(VOID, VOID, removePrefix(pathQueryAndFragment, '#')));
        return true;
      }
      if (tmp == null) {
        // Inline function 'kotlin.run' call
    ...
    var route = Companion_instance_3.n3b(pathQueryAndFragment);
    var tmp_0;
    if (!(route == null)) {
      var data = createPageData($this.a3b_1, route, $this.c3b_1);
      _set_activePageMethod__f6z3vj($this, data.k3b_1);
      _this__u8e3s4.n3a(data.l3b_1);
      tmp_0 = true;
    } else {
      tmp_0 = false;
    }
  ...
  function normalize(_this__u8e3s4, $this) {
    // Inline function 'kotlin.check' call
    if (!Companion_instance_3.m3b(_this__u8e3s4)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    var hrefResolved = Companion_instance_3.o3b(new URL(_this__u8e3s4, window.location.href)).toString();
    // Inline function 'kotlin.takeIf' call
  ...
  function Router$lambda(this$0) {
    return function (it) {
      var tmp = Companion_instance.j3a();
      // Inline function 'kotlin.let' call
  ...
  function Router$renderActivePage$lambda_0($tmp0_rcvr, $pageWrapper, $$changed, $$default) {
    return function ($composer, $force) {
      $tmp0_rcvr.t3b($pageWrapper._v, $composer, updateChangedFlags($$changed | 1), $$default);
      return Unit_instance;
    };
  }
  ...
  function Router() {
    this.z3a_1 = mutableStateOf(null);
    this.a3b_1 = new RouteTree();
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.b3b_1 = ArrayList_init_$Create$_0();
    Companion_instance.k3a(this);
    var tmp_0 = window;
    tmp_0.onpopstate = Router$lambda(this);
    this.c3b_1 = ComposableSingletons$RouterKt_getInstance().v3b_1;
  }
  protoOf(Router).t3b = function (pageWrapper, $composer, $changed, $default) {
    var pageWrapper_0 = {_v: pageWrapper};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.a1w(137063404);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.w1u(pageWrapper_0._v) ? 4 : 2);
    if (!(($default & 2) === 0))
      $dirty = $dirty | 48;
    else if (($changed & 48) === 0)
    ...
    if (!(($dirty & 19) === 18) || !$composer_0.s1t()) {
      if (!(($default & 1) === 0)) {
        pageWrapper_0._v = ComposableSingletons$RouterKt_getInstance().u3b_1;
      }
      ...
      var pageMethod = tmp;
      var tmp_0 = get_PageContextLocal().g21(Companion_instance.j3a());
      // Inline function 'kotlin.run' call
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.l21(Router$renderActivePage$lambda_0(this, pageWrapper_0, $changed, $default));
    }
  };
  protoOf(Router).w3b = function (route, pageMethod) {
    // Inline function 'kotlin.require' call
    if (!(Companion_instance_3.m3b(route) && startsWith(route, _Char___init__impl__6a9atx(47)))) {
    ...
    // Inline function 'kotlin.require' call
    if (!this.a3b_1.i39(Companion_instance_1.y3a(route), pageMethod)) {
      // Inline function 'com.varabyte.kobweb.navigation.Router.register.<anonymous>' call
      var message_0 = 'Registration failure. Path is already registered: ' + route;
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  };
  protoOf(Router).x3b = function (interceptor) {
    this.b3b_1.e(interceptor);
  };
  protoOf(Router).y3b = function (pathQueryAndFragment, updateHistoryMode, openLinkStrategy) {
    if (contains(pathQueryAndFragment, '://'))
      return false;
    var pathQueryAndFragment_0 = Companion_instance_1.y3a(pathQueryAndFragment);
    if (Companion_instance_3.m3b(pathQueryAndFragment_0)) {
    ...
    var tmp;
    if (updatePageContext(Companion_instance.j3a(), this, pathQueryAndFragment_0)) {
      pathQueryAndFragment_0 = Companion_instance.j3a().o3a().x39_1 + partitionPath(pathQueryAndFragment_0, this).se_1;
      // Inline function 'kotlin.let' call
      ...
      var onNewPage = !(window.location.pathname === Companion_instance_3.o3b(new URL(url)).c3a_1);
  ...
  protoOf(Router).z3b = function (pathQueryAndFragment, updateHistoryMode, openLinkStrategy, $super) {
    ...
    return $super === VOID ? this.y3b(pathQueryAndFragment, updateHistoryMode, openLinkStrategy) : $super.y3b.call(this, pathQueryAndFragment, updateHistoryMode, openLinkStrategy);
  };
  protoOf(Router).d3b = function (pathQueryAndFragment, updateHistoryMode, openInternalLinksStrategy, openExternalLinksStrategy) {
    if (!this.y3b(removePrefix(pathQueryAndFragment, window.origin), updateHistoryMode, openInternalLinksStrategy)) {
      open(window, pathQueryAndFragment, openExternalLinksStrategy);
    }
  };
  function RouteInterceptorScope(pathQueryAndFragment) {
    this.p3b_1 = new Route(pathQueryAndFragment);
    this.q3b_1 = this.p3b_1.c3a_1;
    this.r3b_1 = toMutableMap(this.p3b_1.d3a_1);
    this.s3b_1 = this.p3b_1.e3a_1;
  }
  protoOf(RouteInterceptorScope).a3c = function (value) {
    this.q3b_1 = startsWith(value, _Char___init__impl__6a9atx(47)) ? value : '/' + value;
  };
  protoOf(RouteInterceptorScope).f3a = function () {
    return Route_init_$Create$(this.q3b_1, this.r3b_1, this.s3b_1).toString();
  };
  ...
  function ComposableSingletons$RouterKt$lambda_2$lambda_g6ph30(errorCode, $composer, $changed) {
    ...
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.y1u(errorCode) ? 4 : 2);
    if (!(($dirty & 19) === 18) || !$composer_0.s1t()) {
  ...
  function ComposableSingletons$RouterKt() {
    ...
    var tmp = this;
    tmp.u3b_1 = ComposableLambda$invoke$ref_2(composableLambdaInstance(-149473399, false, ComposableSingletons$RouterKt$lambda_1$lambda_cmwzz7));
    var tmp_0 = this;
    tmp_0.v3b_1 = ComposableLambda$invoke$ref_3(composableLambdaInstance(231942886, false, ComposableSingletons$RouterKt$lambda_2$lambda_g6ph30));
  }
  ...
  function DefaultErrorPage(errorCode, $composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.a1w(1095076849);
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.y1u(errorCode) ? 4 : 2);
    if (!(($dirty & 3) === 2) || !$composer_0.s1t()) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.l21(DefaultErrorPage$lambda_0(errorCode, $changed));
    }
  }
  ...
  _.$_$.d = Anchor;
  _.$_$.e = Router;
  _.$_$.f = com_varabyte_kobweb_navigation_Router$stableprop_getter;
  _.$_$.g = remove;
