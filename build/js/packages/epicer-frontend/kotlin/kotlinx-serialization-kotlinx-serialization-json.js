(function (factory) {
  ...
  var toDouble = kotlin_kotlin.$_$.ed;
  var StringCompanionObject_getInstance = kotlin_kotlin.$_$.r4;
  ...
  var toLongOrNull = kotlin_kotlin.$_$.hd;
  var toULongOrNull = kotlin_kotlin.$_$.ld;
  var ULong = kotlin_kotlin.$_$.ye;
  ...
  var toDoubleOrNull = kotlin_kotlin.$_$.dd;
  var toBooleanStrictOrNull = kotlin_kotlin.$_$.cd;
  ...
  var isLetter = kotlin_kotlin.$_$.ic;
  var Char = kotlin_kotlin.$_$.vd;
  var last = kotlin_kotlin.$_$.mc;
  var toString_1 = kotlin_kotlin.$_$.u2;
  var isUpperCase = kotlin_kotlin.$_$.jc;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.i3;
  var UInt__toString_impl_dbgl21 = kotlin_kotlin.$_$.k3;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.r3;
  var ULong__toString_impl_f9au7k = kotlin_kotlin.$_$.t3;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.z2;
  var UByte__toString_impl_v72jg = kotlin_kotlin.$_$.b3;
  var _UShort___init__impl__jigrne = kotlin_kotlin.$_$.a4;
  var UShort__toString_impl_edaoee = kotlin_kotlin.$_$.c4;
  ...
  var polymorphicDefault = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.f2;
  ...
  var DeepRecursiveFunction = kotlin_kotlin.$_$.ae;
  var invoke = kotlin_kotlin.$_$.jf;
  var CoroutineImpl = kotlin_kotlin.$_$.e9;
  var DeepRecursiveScope = kotlin_kotlin.$_$.be;
  var Unit = kotlin_kotlin.$_$.bf;
  ...
  var SuspendFunction2 = kotlin_kotlin.$_$.g9;
  ...
  var substringBefore = kotlin_kotlin.$_$.ad;
  var removeSuffix = kotlin_kotlin.$_$.rc;
  var substringAfter = kotlin_kotlin.$_$.zc;
  var contains = kotlin_kotlin.$_$.bc;
  var plus = kotlin_kotlin.$_$.pf;
  ...
  var isFinite = kotlin_kotlin.$_$.lf;
  var isFinite_0 = kotlin_kotlin.$_$.kf;
  var ChunkedDecoder = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.l1;
  var toUInt = kotlin_kotlin.$_$.kd;
  var _UInt___get_data__impl__f0vqqw = kotlin_kotlin.$_$.j3;
  var toULong = kotlin_kotlin.$_$.md;
  var toUByte = kotlin_kotlin.$_$.jd;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.a3;
  var toUShort = kotlin_kotlin.$_$.nd;
  ...
  var ClosedRange = kotlin_kotlin.$_$.kb;
  var contains_0 = kotlin_kotlin.$_$.ob;
  var single = kotlin_kotlin.$_$.uc;
  var emptySet = kotlin_kotlin.$_$.q6;
  var plus_0 = kotlin_kotlin.$_$.m7;
  var toInt = kotlin_kotlin.$_$.gd;
  var toList = kotlin_kotlin.$_$.b8;
  var throwUninitializedPropertyAccessException = kotlin_kotlin.$_$.rf;
  ...
  var lastIndexOf = kotlin_kotlin.$_$.lc;
  ...
  var chunked = kotlin_kotlin.$_$.ac;
  ...
  initMetadataForClass(JsonPrimitive_1, 'JsonPrimitive', VOID, JsonElement, VOID, VOID, VOID, {0: JsonPrimitiveSerializer_getInstance});
  initMetadataForClass(JsonLiteral, 'JsonLiteral', VOID, JsonPrimitive_1);
  ...
  initMetadataForObject(JsonNull, 'JsonNull', VOID, JsonPrimitive_1, [JsonPrimitive_1, SerializerFactory], VOID, VOID, {0: JsonNullSerializer_getInstance});
  ...
  initMetadataForClass(Composer_0, 'Composer');
  initMetadataForClass(ComposerForUnsignedNumbers, 'ComposerForUnsignedNumbers', VOID, Composer_0);
  initMetadataForClass(ComposerForUnquotedLiterals, 'ComposerForUnquotedLiterals', VOID, Composer_0);
  initMetadataForClass(ComposerWithPrettyPrint, 'ComposerWithPrettyPrint', VOID, Composer_0);
  ...
  protoOf(JsonBuilder).build_bkh6qh_k$ = function () {
    ...
    if (!this.prettyPrint_1) {
      ...
      var tmp3 = this.prettyPrintIndent_1;
      var tmp$ret$4;
      $l$block: {
  ...
  function JsonPrimitive_1() {
    Companion_getInstance_4();
    JsonElement.call(this);
  }
  protoOf(JsonPrimitive_1).toString = function () {
  ...
  function get_jsonPrimitive(_this__u8e3s4) {
    _init_properties_JsonElement_kt__7cbdc2();
    var tmp0_elvis_lhs = _this__u8e3s4 instanceof JsonPrimitive_1 ? _this__u8e3s4 : null;
    var tmp;
  ...
  protoOf(JsonPrimitiveSerializer).serialize_5ase3y_k$ = function (encoder, value) {
    return this.serialize_p6n2zb_k$(encoder, value instanceof JsonPrimitive_1 ? value : THROW_CCE());
  };
  protoOf(JsonPrimitiveSerializer).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (!(result instanceof JsonPrimitive_1))
      throw JsonDecodingException_1(-1, 'Unexpected JSON element, expected JsonPrimitive, had ' + toString(getKClassFromExpression(result)), toString(result));
    return result;
  };
  ...
  protoOf(JsonLiteralSerializer).deserialize_sy6x50_k$ = function (decoder) {
    ...
    if (!(result instanceof JsonLiteral))
      throw JsonDecodingException_1(-1, 'Unexpected JSON element, expected JsonLiteral, had ' + toString(getKClassFromExpression(result)), toString(result));
    return result;
  };
  ...
  function Composer(sb, json) {
    return json.get_configuration_uqypjh_k$().get_prettyPrint_y7fmum_k$() ? new ComposerWithPrettyPrint(sb, json) : new Composer_0(sb);
  }
  ...
  protoOf(Composer_0).get_writer_fne0c5_k$ = function () {
    return this.writer_1;
  };
  protoOf(Composer_0).set_writingFirst_nwqbyc_k$ = function (_set____db54di) {
    this.writingFirst_1 = _set____db54di;
  };
  protoOf(Composer_0).get_writingFirst_pt5bb1_k$ = function () {
    return this.writingFirst_1;
  };
  protoOf(Composer_0).indent_cuntic_k$ = function () {
    this.writingFirst_1 = true;
  };
  protoOf(Composer_0).unIndent_45q4lx_k$ = function () {
    return Unit_getInstance();
  };
  protoOf(Composer_0).nextItem_40n9p2_k$ = function () {
    this.writingFirst_1 = false;
  };
  protoOf(Composer_0).nextItemIfNotFirst_9wb040_k$ = function () {
    this.writingFirst_1 = false;
  };
  protoOf(Composer_0).space_po67ue_k$ = function () {
    return Unit_getInstance();
  };
  protoOf(Composer_0).print_uoq3bk_k$ = function (v) {
    return this.writer_1.writeChar_w2y76g_k$(v);
  };
  protoOf(Composer_0).print_wtfns3_k$ = function (v) {
    return this.writer_1.write_mozxwr_k$(v);
  };
  protoOf(Composer_0).print_81xt5n_k$ = function (v) {
    return this.writer_1.write_mozxwr_k$(v.toString());
  };
  protoOf(Composer_0).print_3xddxz_k$ = function (v) {
    return this.writer_1.write_mozxwr_k$(v.toString());
  };
  protoOf(Composer_0).print_p65m4b_k$ = function (v) {
    return this.writer_1.writeLong_2rx6yl_k$(toLong(v));
  };
  protoOf(Composer_0).print_l5t6fv_k$ = function (v) {
    return this.writer_1.writeLong_2rx6yl_k$(toLong(v));
  };
  protoOf(Composer_0).print_ay1yo5_k$ = function (v) {
    return this.writer_1.writeLong_2rx6yl_k$(toLong(v));
  };
  protoOf(Composer_0).print_adpg1_k$ = function (v) {
    return this.writer_1.writeLong_2rx6yl_k$(v);
  };
  protoOf(Composer_0).print_u0bpvs_k$ = function (v) {
    return this.writer_1.write_mozxwr_k$(v.toString());
  };
  protoOf(Composer_0).printQuoted_gtxn2t_k$ = function (value) {
  ...
  protoOf(ComposerForUnquotedLiterals).printQuoted_gtxn2t_k$ = function (value) {
    if (this.forceQuoting_1) {
      protoOf(Composer_0).printQuoted_gtxn2t_k$.call(this, value);
    } else {
      protoOf(Composer_0).print_wtfns3_k$.call(this, value);
    }
  };
  ...
  function JsonSerializersModuleValidator(configuration) {
    this.discriminator_1 = configuration.get_classDiscriminator_x3y365_k$();
  ...
  protoOf(JsonSerializersModuleValidator).polymorphic_74dxah_k$ = function (baseClass, actualClass, actualSerializer) {
    ...
    if (!this.useArrayPolymorphism_1 && this.isDiscriminatorRequired_1) {
  ...
  function encodePolymorphically(_this__u8e3s4, serializer, value, ifPolymorphic) {
    ...
    if (isPolymorphicSerializer) {
      ...
      if (!(baseClassDiscriminator == null)) {
        ...
        checkKind_0(actual.get_descriptor_wjt6a0_k$().get_kind_wop7ml_k$());
      }
  ...
  function decodeSerializableValuePolymorphic(_this__u8e3s4, deserializer, path) {
    ...
    if (!(tmp0 instanceof JsonObject)) {
      throw JsonDecodingException_1(-1, 'Expected ' + getKClass(JsonObject).get_simpleName_r6f8py_k$() + ', but had ' + getKClassFromExpression(tmp0).get_simpleName_r6f8py_k$() + ' as the serialized body of ' + serialName + ' at element: ' + path(), toString(tmp0));
    }
    var jsonTree = tmp0;
    ...
    try {
      ...
      if ($p instanceof SerializationException) {
        var it = $p;
        throw JsonDecodingException_1(-1, ensureNotNull(it.message), jsonTree.toString());
      } else {
        throw $p;
      }
    }
      ...
      if (tmp0_elvis_lhs == null) {
        ...
        $l$block: {
          ...
          if (!(tmp0 instanceof JsonObject)) {
            ...
            throw JsonDecodingException_1(-1, 'Expected ' + tmp_2 + ', but had ' + tmp_3 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$1, toString(tmp0));
          }
          var jsonTree = tmp0;
          ...
          var tmp_4;
          try {
            tmp_4 = findPolymorphicSerializer_0(tmp1, this, type);
          } catch ($p) {
            var tmp_5;
            if ($p instanceof SerializationException) {
              var it = $p;
  ...
  function readJson(json, element, deserializer) {
    ...
    if (element instanceof JsonObject) {
      ...
      if (element instanceof JsonArray) {
        ...
        if (tmp_0) {
          tmp = new JsonPrimitiveDecoder(json, element instanceof JsonPrimitive_1 ? element : THROW_CCE());
        } else {
          noWhenBranchMatchedException();
        }
      }
  ...
  function getPrimitiveValue($this, tag, primitiveName, convert) {
    ...
    if (!(value instanceof JsonPrimitive_1)) {
      var tmp = getKClass(JsonPrimitive_1).get_simpleName_r6f8py_k$();
      ...
      throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + primitiveName + ' at element: ' + tmp$ret$0, toString(value));
    }
    var literal = value;
    try {
  ...
  function unparsedPrimitive($this, literal, primitive, tag) {
    ...
    throw JsonDecodingException_1(-1, "Failed to parse literal '" + literal.toString() + "' as " + type + ' value at element: ' + $this.renderTagStack_ixxubu_k$(tag), toString($this.currentObject_yxe2oo_k$()));
  }
  ...
  protoOf(AbstractJsonTreeDecoder).decodeSerializableValue_xpnpad_k$ = function (deserializer) {
    ...
    $l$block: {
      ...
      if (!(tmp0 instanceof JsonObject)) {
        ...
        throw JsonDecodingException_1(-1, 'Expected ' + tmp_0 + ', but had ' + tmp_1 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$1, toString(tmp0));
      }
      var jsonTree = tmp0;
      var tmp0_safe_receiver = jsonTree.get_6bo4tg_k$(discriminator);
      var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : get_jsonPrimitive(tmp0_safe_receiver);
  ...
  protoOf(AbstractJsonTreeDecoder).beginStructure_yljocp_k$ = function (descriptor) {
    ...
    if (tmp_0) {
      ...
      if (!(currentObject instanceof JsonArray)) {
        ...
        throw JsonDecodingException_1(-1, 'Expected ' + tmp_2 + ', but had ' + tmp_3 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(currentObject));
      }
      ...
      if (equals(tmp0_subject, MAP_getInstance())) {
        ...
        if (tmp_5) {
          ...
          if (!(currentObject instanceof JsonObject)) {
            ...
            throw JsonDecodingException_1(-1, 'Expected ' + tmp_7 + ', but had ' + tmp_8 + ' as the serialized body of ' + serialName_0 + ' at element: ' + tmp$ret$3, toString(currentObject));
          }
          ...
          if (this_0.get_configuration_uqypjh_k$().get_allowStructuredMapKeys_fk21t_k$()) {
            ...
            if (!(currentObject instanceof JsonArray)) {
              ...
              throw JsonDecodingException_1(-1, 'Expected ' + tmp_10 + ', but had ' + tmp_11 + ' as the serialized body of ' + serialName_1 + ' at element: ' + tmp$ret$7, toString(currentObject));
            }
        ...
        if (!(currentObject instanceof JsonObject)) {
          ...
          throw JsonDecodingException_1(-1, 'Expected ' + tmp_13 + ', but had ' + tmp_14 + ' as the serialized body of ' + serialName_2 + ' at element: ' + tmp$ret$12, toString(currentObject));
        }
  ...
  protoOf(AbstractJsonTreeDecoder).getPrimitiveValue_cue515_k$ = function (tag, descriptor) {
    ...
    // Inline function 'kotlinx.serialization.json.internal.cast' call
    var serialName = descriptor.get_serialName_u2rqhk_k$();
    if (!(tmp1 instanceof JsonPrimitive_1)) {
      var tmp = getKClass(JsonPrimitive_1).get_simpleName_r6f8py_k$();
      var tmp_0 = getKClassFromExpression(tmp1).get_simpleName_r6f8py_k$();
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp1));
    }
    return tmp1;
  };
  protoOf(AbstractJsonTreeDecoder).decodeTaggedEnum_lbnta6_k$ = function (tag, enumDescriptor) {
    ...
    if (!(tmp1 instanceof JsonPrimitive_1)) {
      var tmp_0 = getKClass(JsonPrimitive_1).get_simpleName_r6f8py_k$();
      var tmp_1 = getKClassFromExpression(tmp1).get_simpleName_r6f8py_k$();
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_1(-1, 'Expected ' + tmp_0 + ', but had ' + tmp_1 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp1));
    }
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedBoolean_8s5b84_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'boolean' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedByte_oje7fc_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'byte' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedShort_b0y92g_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'short' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedInt_9hzwhn_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'int' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedLong_uzg5b0_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'long' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedFloat_hjyf60_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'float' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedDouble_u6dgwh_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'double' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedChar_ha7850_k$ = function (tag) {
    ...
    $l$block: {
      ...
      if (!(value instanceof JsonPrimitive_1)) {
        ...
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'char' + ' at element: ' + tmp$ret$0, toString(value));
      }
      var literal = value;
      try {
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedString_fe7ocx_k$ = function (tag) {
    ...
    if (!(value instanceof JsonPrimitive_1)) {
      ...
      // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
      var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
      throw JsonDecodingException_1(-1, 'Expected ' + tmp + ', but had ' + tmp_0 + ' as the serialized body of ' + 'string' + ' at element: ' + tmp$ret$0, toString(value));
    }
    var value_0 = value;
    if (!(value_0 instanceof JsonLiteral))
      throw JsonDecodingException_1(-1, "Expected string value for a non-null key '" + tag + "', got null literal instead at element: " + this.renderTagStack_ixxubu_k$(tag), toString(this.currentObject_yxe2oo_k$()));
    if (!value_0.get_isString_zep7bw_k$() && !this.get_json_woos35_k$().get_configuration_uqypjh_k$().get_isLenient_1g1x8_k$()) {
      throw JsonDecodingException_1(-1, "String literal for key '" + tag + "' should be quoted at element: " + this.renderTagStack_ixxubu_k$(tag) + ".\nUse 'isLenient = true' in 'Json {}' builder to accept non-compliant JSON.", toString(this.currentObject_yxe2oo_k$()));
    }
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedInline_tuyvom_k$ = function (tag, inlineDescriptor) {
    ...
    if (get_isUnsignedNumber(inlineDescriptor)) {
      ...
      if (!(tmp1 instanceof JsonPrimitive_1)) {
        var tmp_1 = getKClass(JsonPrimitive_1).get_simpleName_r6f8py_k$();
        var tmp_2 = getKClassFromExpression(tmp1).get_simpleName_r6f8py_k$();
        // Inline function 'kotlinx.serialization.json.internal.AbstractJsonTreeDecoder.cast.<anonymous>' call
        var tmp$ret$0 = this.renderTagStack_ixxubu_k$(tag);
        throw JsonDecodingException_1(-1, 'Expected ' + tmp_1 + ', but had ' + tmp_2 + ' as the serialized body of ' + serialName + ' at element: ' + tmp$ret$0, toString(tmp1));
      }
  ...
  function coerceInputValue_0($this, descriptor, index, tag) {
    ...
    $l$block_2: {
      ...
      if (equals(elementDescriptor.get_kind_wop7ml_k$(), ENUM_getInstance())) {
        ...
        var tmp0_safe_receiver = tmp_3 instanceof JsonPrimitive_1 ? tmp_3 : null;
  ...
  protoOf(JsonTreeDecoder).endStructure_1xqz0n_k$ = function (descriptor) {
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      ...
      if (!names.contains_aljjnj_k$(key) && !(key === this.polymorphicDiscriminator_1)) {
        throw JsonDecodingException_0(-1, "Encountered an unknown key '" + key + "' at element: " + this.renderTagStack_rja478_k$() + '\n' + "Use 'ignoreUnknownKeys = true' in 'Json {}' builder or '@JsonIgnoreUnknownKeys' annotation to ignore unknown keys.\n" + ('JSON input: ' + toString(minify(this.get_value_j01efc_k$().toString()))));
      }
    }
  };
  ...
  protoOf(JsonTreeMapDecoder).currentElement_4dg47r_k$ = function (tag) {
    return (this.position_2 % 2 | 0) === 0 ? JsonPrimitive(tag) : getValue(this.value_3, tag);
  };
  ...
  protoOf(AbstractJsonTreeEncoder).encodeTaggedChar_hlt81x_k$ = function (tag, value) {
    return this.putElement_rnqfb1_k$(tag, JsonPrimitive(toString_1(value)));
  };
  ...
  protoOf(AbstractJsonTreeEncoder).encodeTaggedString_wkr2bh_k$ = function (tag, value) {
    return this.putElement_rnqfb1_k$(tag, JsonPrimitive(value));
  };
  ...
  protoOf(AbstractJsonTreeEncoder).encodeTaggedEnum_56ln9q_k$ = function (tag, enumDescriptor, ordinal) {
    return this.putElement_rnqfb1_k$(tag, JsonPrimitive(enumDescriptor.getElementName_u4sqmf_k$(ordinal)));
  };
  ...
  protoOf(AbstractJsonTreeEncoder).encodeTaggedValue_sfcjfh_k$ = function (tag, value) {
    this.putElement_rnqfb1_k$(tag, JsonPrimitive(toString(value)));
  };
  ...
  protoOf(AbstractJsonTreeEncoder).beginStructure_yljocp_k$ = function (descriptor) {
    ...
    if (!(discriminator == null)) {
      if (encoder instanceof JsonTreeMapEncoder) {
        encoder.putElement_rnqfb1_k$('key', JsonPrimitive(discriminator));
        var tmp1_elvis_lhs = this.polymorphicSerialName_1;
        encoder.putElement_rnqfb1_k$('value', JsonPrimitive(tmp1_elvis_lhs == null ? descriptor.get_serialName_u2rqhk_k$() : tmp1_elvis_lhs));
      } else {
        var tmp2_elvis_lhs = this.polymorphicSerialName_1;
        encoder.putElement_rnqfb1_k$(discriminator, JsonPrimitive(tmp2_elvis_lhs == null ? descriptor.get_serialName_u2rqhk_k$() : tmp2_elvis_lhs));
      }
      this.polymorphicDiscriminator_1 = null;
      this.polymorphicSerialName_1 = null;
    }
    ...
    $l$loop: while (true) {
      ...
      if (tmp0_subject === 8 || tmp0_subject === 6) {
        ...
        if (!(last_0(tokenStack) === 8))
          throw JsonDecodingException_1(this.currentPosition_1, 'found ] instead of } at path: ' + this.path_1.toString(), this.get_source_jl0x7o_k$());
  ...
  protoOf(AbstractJsonLexer).fail_3kj0i_k$ = function (message, position, hint) {
    ...
    var hintMessage = tmp;
    throw JsonDecodingException_1(position, message + ' at path: ' + this.path_1.getPath_18su3p_k$() + hintMessage, this.get_source_jl0x7o_k$());
  };
