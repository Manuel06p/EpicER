(function (factory) {
  ...
  var trimStart = kotlin_kotlin.$_$.xf;
  ...
  var FetchDefaults_getInstance = kotlin_com_varabyte_kobweb_browser_ext.$_$.k;
  ...
  var A = kotlin_org_jetbrains_compose_html_html_core.$_$.s5;
  ...
  var startsWith_0 = kotlin_kotlin.$_$.if;
  var dropLast = kotlin_kotlin.$_$.ke;
  ...
  var contains_0 = kotlin_kotlin.$_$.ie;
  var toMutableMap = kotlin_kotlin.$_$.ca;
  ...
  protoOf(Router).register_vkebx7_k$ = function (route, pageMethod) {
    ...
    // Inline function 'kotlin.require' call
    if (!this.routeTree_1.register_ela2uv_k$(Companion_getInstance_2().prepend_osifcc_k$(route), pageMethod)) {
      // Inline function 'com.varabyte.kobweb.navigation.Router.register.<anonymous>' call
  ...
  _.$_$.e = Anchor;
  _.$_$.f = Router;
  _.$_$.g = com_varabyte_kobweb_navigation_Router$stableprop_getter;
  _.$_$.h = remove;
