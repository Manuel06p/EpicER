(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).ai = function () {
    return this.zh_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.zh_1[index];
  };
  ...
  protoOf(AtomicRef).bi = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).ci = function () {
  ...
  protoOf(AtomicBoolean).di = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).ci = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).ei = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).ci = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).fi = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).ci = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).ai);
  //endregion
