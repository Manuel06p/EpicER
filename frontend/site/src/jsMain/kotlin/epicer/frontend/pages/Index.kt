...
import epicer.frontend.HeadlineTextStyle
import epicer.frontend.SubheadlineTextStyle
import epicer.frontend.components.layouts.PageLayout
...
@Composable
fun HomePage() {
    val newUser = NewUserDTO("sc", "ss", "Finalmente funziona!")
    Text(newUser.name)
    PageLayout("Home") {
